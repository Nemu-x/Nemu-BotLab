...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    try {
      ...
      if (!tableInfo.media_type) {
        ...
        console.log('Added media_type column to messages table');
      }
      ...
      if (!tableInfo.media_id) {
        ...
        console.log('Added media_id column to messages table');
      }
      ...
      if (!tableInfo.media_caption) {
        ...
        console.log('Added media_caption column to messages table');
      }
      ...
      if (!tableInfo.media_size) {
        ...
        console.log('Added media_size column to messages table');
      }
      ...
      if (!tableInfo.media_filename) {
        ...
        console.log('Added media_filename column to messages table');
      }
      ...
      if (!tableInfo.location_data) {
        ...
        console.log('Added location_data column to messages table');
      }
      ...
      if (!tableInfo.contact_data) {
        ...
        console.log('Added contact_data column to messages table');
      }
    } catch (error) {
  ...
  async down (queryInterface, Sequelize) {
    try {
      ...
      console.log('Removed media columns from messages table');
    } catch (error) {
